...
# Source: https://github.com/prioritizr/prioritizr/blob/HEAD/R/standalone-assertions_class.R
# Generated by: usethis::use_standalone("prioritizr/prioritizr", "assertions_class")
# ----------------------------------------------------------------------
#
# ---
