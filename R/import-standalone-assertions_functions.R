...
# Source: https://github.com/prioritizr/prioritizr/blob/HEAD/R/standalone-assertions_functions.R
# Generated by: usethis::use_standalone("prioritizr/prioritizr", "assertions_functions")
# ----------------------------------------------------------------------
#
# ---
