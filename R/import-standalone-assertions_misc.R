...
# Source: https://github.com/prioritizr/prioritizr/blob/HEAD/R/standalone-assertions_misc.R
# Generated by: usethis::use_standalone("prioritizr/prioritizr", "assertions_misc")
# ----------------------------------------------------------------------
#
# ---
